...
{
    class UshortHours : SignalProcessorBase, ISignalGenerator
    {
        public static DiagramComponent GetDiagramComponent()
        {
            return new DiagramComponent
            {
                ...
                ComponentJsName = "UshortHoursComponent",
                ComponentName = "Time (hours)",
        ...
        {
            debug?.AppendLine($"UshortHours (0) => {(ushort)DateTime.Now.Hour}");
            return (ushort)DateTime.Now.Hour;
        }
    }
